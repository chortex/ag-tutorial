      ...
      <React.Fragment>
        <div className='pb-4'>
          ...
          <p>First of all you must turn off your vertical synchronizer. Otherwise your fps limit will be 60 fps. 
            More details how deactivate vertical synchronizer you can find <a href='https://nvidia.custhelp.com/app/answers/detail/a_id/2469/~/turning-off-v-sync-to-boost-performance-on-quadro-based-cards' target='_blank' rel="noopener noreferrer">here</a>.
          </p>
          <p>Also you have to turn off mouse acceleration. There are a couple of players who play with acceleration but they are exceptations. 
            To get best mouse control you have to deactivate acceleration. More details about deactivation mouse acceleration you can find <a href='https://www.wepc.com/how-to/turn-off-mouse-acceleration-in-windows/' target='_blank' rel="noopener noreferrer">here</a>.
          </p>
